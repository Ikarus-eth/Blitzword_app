...
Build: `enemy-groups-20260925-r2` (initial feature release: `enemy-groups-20260925-r1`). Authorized by the user: “then implement what we discussed, deploy and confirm”.
