...
| Narration | 990 recovered exact-text clips are mapped at runtime. Representative QA reviewed 42 clips; six bad clips were replaced with user-approved recordings, including standalone gate and a slower evolution-3. The four longer gate recordings were approved and re-enabled. | [Narration release](NARRATION_RELEASE.md) |

## Outstanding work and ownership

- Narration recovery and targeted QA replacement are integrated: all 990 exact-text corpus clips are now approved for runtime. The user reviewed 42 representative clips, rejecting six and approving six targeted replacements; all 12 extra earlier-Tom word samples were good. Chapter-story and some composite shield-correction phrases still use device speech where no exact clip exists. Static target highlighting remains; accurate recorded word-boundary highlighting, exhaustive listening and physical iPad gameplay playback remain unfinished.
...
| 5 | Narration | Representative QA complete; six bad clips replaced and approved, all five gate phrases enabled. Remaining story/composite gaps, exhaustive listening and physical iPad review stay open |
