...
| Narration | 1,029 exact-text clips are mapped and Pages-deployed: 990 recovered/core, four Pip-evolution, 34 chapter-story introductions and one reusable shield prefix. Story introductions/shield use ElevenLabs George at 0.90×; child-read story sentences remain local pending approved rewrites. Build `narration-remainder-20260924-r1`. | [Narration release](NARRATION_RELEASE.md) |
